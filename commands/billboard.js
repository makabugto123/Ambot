...
module.exports = {
  ...
  async execute(senderId, args, pageAccessToken) {
    ...
    const apiUrl = `https://api-canvass.vercel.app/billboard?text=${encodeURIComponent(prompt)}`;  // API endpoint with the prompt
