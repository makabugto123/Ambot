...
module.exports = {
  ...
  name: 'photoleap',  // Command name
  description: 'Generate HD picture through your prompt',  // Description
  usage: 'photoleap [prompt]',  // Usage
  ...
  async execute(senderId, args, pageAccessToken) {
    ...
    const apiUrl = `https://joshweb.click/aigen?prompt=${encodeURIComponent(prompt)}`;  // API endpoint with the prompt
const response = await axios.get(apiUrl);
const imglink = response.data.result;
